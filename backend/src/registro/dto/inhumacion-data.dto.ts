...
/**
 * DTO para los datos de inhumación cuando se envían como parte
 * de la creación de un difunto. No requiere difuntoId porque
 * se asigna automáticamente desde el difunto creado.
 */
export class InhumacionDataDto {
    @ApiProperty({
